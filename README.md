...
| **学术 / 论文** | Google Scholar / arXiv / 知网 / PatSnap paper | 学术论文、引用网络 | 🌐 通用联网可达 |
...
> **诚实声明（重要）**：本 Skill 只集成**当前环境真实存在**的 Skill / 连接器。Firecrawl、Crunchbase Pro、PitchBook 等在本环境未提供的服务**不会**被声明为已集成——若你所在平台提供，可自行在 Step 1 搜索入口追加，但 README / SKILL.md 不虚假标注。Tavily、GitHub、agent-reach、agent-browser、markitdown、tdx-connector 为当前环境真实可用项，已在上表标 ✅。
